...
ViewContainer::ViewContainer(View* wfirstView, View* wlastView, View* wselected) {
...
void View::draw(byte xgroup) {
 xgroup++; //does nothing, just so that the compiler does not print warnings
}
...
void LabelView::setText(const __FlashStringHelper *xtext) {
  text = xtext;
}
//////////////////////////// class Time View ///////////////////////////
