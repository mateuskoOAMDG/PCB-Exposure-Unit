/**************************************************************************
  PCB Exposure Unit with count down timer. Arduino project.
  Copyright (C) 2024 mateusko O.A.M.D.G
  
  
  Project: PCB Exposure Unit (Encoder + OLED 128 x 32)
  File   : OsvitkaOLED.ino
  MCU    : ATMEGA328P
  PCB    : (PINOUT) 1.0.2 
  Version: 1.0.12
  Date   : 2024-05-07,2025-09-10
  Author : (c) Martin Janček, mateusko.OAMDG@outlook.com
  License: MIT Licence

  Timer for PCB Exposure Unit. 
  It uses a 128x32 OLED display and an encoder with a button.
  The time can be set from 1 second to 99 minutes in 1-second increments.
